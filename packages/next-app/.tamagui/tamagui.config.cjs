...
var require_useGet = __commonJS({
  "../../node_modules/@tamagui/use-event/dist/cjs/useGet.js"(exports, module2) {
    ...
    var useIsomorphicLayoutEffect14 = !isWeb28 || isClient7 ? import_react47.useLayoutEffect : import_react47.useEffect;
    ...
    function focusableInputHOC3(Component) {
      const component = Component.styleable(
        (props, ref) => {
          ...
          const inputValue = (0, import_react47.useRef)(props.value || props.defaultValue || "");
    ...
    function createAnimations2(animations2) {
      ...
      return {
        ...
        useAnimations: ({ props, onDidAnimate, style, state, presence }) => {
          ...
          const isThereNoNativeStyleKeys = (0, import_react47.useMemo)(() => {
          ...
          const res = (0, import_react47.useMemo)(() => {
            var _a;
            const runners = [];
            const completions = [];
...
var SheetImplementationCustom = (0, import_core12.themeable)(
  (0, import_react18.forwardRef)(/* @__PURE__ */ __name(function SheetImplementationCustom2(props, forwardedRef) {
    ...
    const at = (0, import_react18.useRef)(0);
    useAnimatedNumberReaction(
      {
...
var SheetScrollView = (0, import_react19.forwardRef)(
  ({ __scopeSheet, children, ...props }, ref) => {
    ...
    const [percentToPadBottom, setPercentToPadBottom] = (0, import_react19.useState)(0);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
      ScrollView,
      {
        ...
        ...props,
        children: [
          (0, import_react19.useMemo)(() => children, [children]),
...
function useButton(propsIn, { Text: Text5 = Button2.Text } = { Text: Button2.Text }) {
  ...
  const isNested = import_web8.isRSC ? false : (0, import_react23.useContext)(import_web8.ButtonNestingContext);
  ...
  CardFrame.styleable(
    (0, import_react24.forwardRef)(
      ({ __scopeCard, children, ...props }, ref) => {
        return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(CardFrame, { ref, ...props, children: import_react24.default.Children.map(children, (child) => {
